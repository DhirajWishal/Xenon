...
namespace Xenon
{
	...
	{
		/**
		 * DirectX 12 uniform buffer class.
		 */
		class DX12UniformBuffer final : public UniformBuffer, public DX12Buffer
		{
		public:
			/**
			 ...
			 */
			explicit DX12UniformBuffer(DX12Device* pDevice, uint64_t size);
